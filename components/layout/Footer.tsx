    ...
    <footer className="mt-20 py-8 border-t border-white/10" role="contentinfo">
      <div className="container-custom">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-3 group" aria-label="AARA Prep Home">
          ...
          <p className="text-gray-500 text-sm">© {new Date().getFullYear()} AARA Prep. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
