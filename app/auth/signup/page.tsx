  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#050505] selection:bg-blue-500/30">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[30%] left-[50%] -translate-x-1/2 w-[600px] h-[300px] bg-indigo-900/10 blur-[100px] rounded-full" />
      </div>
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 text-sm">Start your journey with AARA</p>
        </div>
