    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const assistantMessage: Message = {
                role: 'assistant',
                content: "AARA Chat is coming soon! 🌟\n\nWe're building an intelligent companion designed to help you understand your emotions, patterns, and yourself better. It will be a safe, judgment-free space to explore your thoughts.",
                timestamp: new Date().toISOString(),
            }
